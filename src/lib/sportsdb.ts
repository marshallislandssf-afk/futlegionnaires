...
const COUNTRY_CONFEDERATION: Record<string, Confederation> = {
  ...
  France:'UEFA',Germany:'UEFA',Spain:'UEFA',Italy:'UEFA',Portugal:'UEFA',
  Netherlands:'UEFA',Belgium:'UEFA',Switzerland:'UEFA',Austria:'UEFA',
  Turkey:'UEFA',Greece:'UEFA',Croatia:'UEFA',Serbia:'UEFA',Ukraine:'UEFA',
  Russia:'UEFA',Poland:'UEFA',Sweden:'UEFA',Norway:'UEFA',Denmark:'UEFA',
  Finland:'UEFA',Iceland:'UEFA',Ireland:'UEFA','Republic of Ireland':'UEFA',
  Israel:'UEFA',Kazakhstan:'UEFA',Armenia:'UEFA',Georgia:'UEFA',
  Azerbaijan:'UEFA',Moldova:'UEFA',Estonia:'UEFA',Latvia:'UEFA',
  Lithuania:'UEFA',Belarus:'UEFA',Hungary:'UEFA',Romania:'UEFA',
  Bulgaria:'UEFA',Czechia:'UEFA','Czech Republic':'UEFA',Slovakia:'UEFA',
  Slovenia:'UEFA',Albania:'UEFA',Kosovo:'UEFA','North Macedonia':'UEFA',
  Montenegro:'UEFA','Bosnia and Herzegovina':'UEFA',Luxembourg:'UEFA',
  Malta:'UEFA',Cyprus:'UEFA',Gibraltar:'UEFA',
  // CAF
  ...
  'DR Congo':'CAF',Congo:'CAF',Gabon:'CAF',Guinea:'CAF','Cabo Verde':'CAF',
  'Cape Verde':'CAF','Burkina Faso':'CAF',Togo:'CAF',Benin:'CAF',
  Rwanda:'CAF',Uganda:'CAF','Equatorial Guinea':'CAF',Liberia:'CAF',
  'Sierra Leone':'CAF',Gambia:'CAF','Guinea-Bissau':'CAF',Mauritania:'CAF',
  Sudan:'CAF','South Sudan':'CAF',Libya:'CAF','Central African Republic':'CAF',
  Chad:'CAF',Niger:'CAF',Angola:'CAF',Mozambique:'CAF',Namibia:'CAF',
  Botswana:'CAF',Lesotho:'CAF',Eswatini:'CAF','South Africa':'CAF',
  Malawi:'CAF',Madagascar:'CAF',Mauritius:'CAF',Seychelles:'CAF',
  Comoros:'CAF',Djibouti:'CAF',Eritrea:'CAF',Somalia:'CAF',
  'Sao Tome and Principe':'CAF',Burundi:'CAF',
  // CONMEBOL
  ...
  // CONCACAF
  'United States':'CONCACAF',USA:'CONCACAF',Mexico:'CONCACAF',Canada:'CONCACAF',
  Jamaica:'CONCACAF',Haiti:'CONCACAF','Trinidad and Tobago':'CONCACAF',
  Honduras:'CONCACAF','Costa Rica':'CONCACAF','El Salvador':'CONCACAF',
  Guatemala:'CONCACAF',Panama:'CONCACAF',Cuba:'CONCACAF',
  Guadeloupe:'CONCACAF',Martinique:'CONCACAF',Suriname:'CONCACAF',
  Curacao:'CONCACAF','Dominican Republic':'CONCACAF',Barbados:'CONCACAF',
  Belize:'CONCACAF',Nicaragua:'CONCACAF',Guyana:'CONCACAF',
  'French Guiana':'CONCACAF','Saint Kitts and Nevis':'CONCACAF',
  'Saint Lucia':'CONCACAF','Saint Vincent and the Grenadines':'CONCACAF',
  Grenada:'CONCACAF',Bermuda:'CONCACAF',
  // AFC
  Japan:'AFC','South Korea':'AFC',China:'AFC',Australia:'AFC',Iran:'AFC',
  'Saudi Arabia':'AFC',Qatar:'AFC',UAE:'AFC','United Arab Emirates':'AFC',
  Iraq:'AFC',Jordan:'AFC',Kuwait:'AFC',Bahrain:'AFC',Oman:'AFC',Yemen:'AFC',
  Syria:'AFC',Lebanon:'AFC',Palestine:'AFC',India:'AFC',Pakistan:'AFC',
  Bangladesh:'AFC','Sri Lanka':'AFC',Nepal:'AFC',Afghanistan:'AFC',
  Indonesia:'AFC',Philippines:'AFC',Vietnam:'AFC',Thailand:'AFC',
  Malaysia:'AFC',Singapore:'AFC',Myanmar:'AFC',Cambodia:'AFC',Laos:'AFC',
  'Timor-Leste':'AFC',Brunei:'AFC',Mongolia:'AFC',Uzbekistan:'AFC',
  Kyrgyzstan:'AFC',Tajikistan:'AFC',Turkmenistan:'AFC',
  'North Korea':'AFC','Hong Kong':'AFC',
  // OFC
  'New Zealand':'OFC','Papua New Guinea':'OFC',Fiji:'OFC',Vanuatu:'OFC',
  'Solomon Islands':'OFC',Samoa:'OFC',Tonga:'OFC',Kiribati:'OFC',
  Tuvalu:'OFC','Marshall Islands':'OFC',Nauru:'OFC',Palau:'OFC',
  'New Caledonia':'OFC','American Samoa':'OFC',
}
